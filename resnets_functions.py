...
def identity_block(X, f, filters, stage, block):
    """
    Implementation of the identity block as CONV2D -> BATCH -> RELU -> CONV2D -> BATCH -> RELU -> CONV2D -> BATCH + (X_shortcut) -> RELU
...
def convolutional_block(X, f, filters, stage, block, s = 2):
    """
    Implementation of the convolutional block as CONV2D -> BATCH -> RELU -> CONV2D -> BATCH -> RELU -> CONV2D -> BATCH + (X_shortcut -> CONV2D-> BATCH) -> RELU
